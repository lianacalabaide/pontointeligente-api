...
public class LancamentoControllerTest {
	...
	public void testCadastrarLancamento() throws Exception {
		...
		when(this.funcionarioService.buscarFuncionarioPorId(any())).thenReturn(Optional.of(new Funcionario()));
		when(this.lancamentoService.persistir(any())).thenReturn(lancamento);
	...
	public void testRemoverLancamento() throws Exception {
		when(this.lancamentoService.buscarLancamentoPorId(any())).thenReturn(Optional.of(new Lancamento()));
	...
	private String obterJsonRequisicaoPost() throws JsonProcessingException {
		...
		lancamentoDto.setFuncionarioId(ID_FUNCIONARIO.toString());
